...
A small script to announces the winners of NYT word games (Wordle, Connections, Strands, and Pips) and other games (Memoku, Bracket City, Parseword, Raddle) to a Slack channel.
